...
from lib.DSC import DSC_Module
...
class Network(nn.Module):
    ...
    def __init__(self, channel=32, imagenet_pretrained=True):
        ...
        self.DSC2 = DSC_Module(512,channel)
        self.DSC3 = DSC_Module(1024,channel)
        self.DSC4 = DSC_Module(2048,channel)
    ...
    def forward(self, x):
        ...
        x2_rfb = self.DSC2(x2)       # channel -> 32
        x3_rfb = self.DSC3(x3)         # channel -> 32
        x4_rfb = self.DSC4(x4)          # channel -> 32
...
#         self.DSC2 = DSC_Module(1024,channel)
#         self.DSC3 = DSC_Module(512,channel)
...
#         # Neighbourhood Connected Decoder
#         S_g = self.NCD(x4_rfb, x3_rfb, x2_rfb, d2, d3)
#         S_g_pred = F.interpolate(S_g, scale_factor=8, mode='bilinear')    # Sup-1 (bs, 1, 44, 44) -> (bs, 1, 352, 352)
