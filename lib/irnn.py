...
IRNNForward  = open('/data/rs/jq/code/SINet-V2-main/lib/IRNN_Forward_cuda.cu','r').read()

IRNNBackward = open('/data/rs/jq/code/SINet-V2-main/lib/IRNN_Backward_cuda.cu','r').read()
...
def cunnex(strFunction):
	# return cupy.cuda.compile_with_cache().get_function(strFunction)
